 ...
 */
public class VoiceRecognizeActivity extends BaseActivity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(VoiceRecognizeActivity.this);
